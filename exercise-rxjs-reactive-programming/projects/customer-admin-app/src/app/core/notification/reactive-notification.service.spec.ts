...
describe('ReactiveNotificationService', () => {
  ...
  it('should add and remove info notification', () => {
    testScheduler.run(({ expectObservable }) => {
      ...
      // TODO 17: notice that we can implement reactive notifications test WITHOUT real time
  ...
  it('should handle addition and cleanup of multiple notifications in parallel', () => {
    testScheduler.run(({ expectObservable }) => {
      ...
      // TODO 18: notice that we can implement even very complex scenarios with ease
