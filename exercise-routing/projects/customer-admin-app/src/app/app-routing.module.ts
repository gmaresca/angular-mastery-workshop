...
const routes: Routes = [
  // TODO 4: add route that matches empty route '' and redirects it to 'home', explore pathMatch property options, and try to navigate to http://localhost:4200, hint: use pathMatch: 'full'
  {
    path: 'home',
  ...
  // TODO 5: try navigating to nonexistent route, eg http://localhost:4200/wrong and see what happens (browser console)
